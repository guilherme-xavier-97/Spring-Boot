...
public enum PerfilDeUsuario {
	//A palavra "ROLE" é exigencia do spring
	ADMIN (1, "ROLE_ADMIN"),
	...
	private PerfilDeUsuario (int cod, String descricao) {
		this.cod = cod;
	...
	public static PerfilDeUsuario toEnum (Integer cod) {
		if (cod == null) {
			return null;
		}
		
		for (PerfilDeUsuario x: PerfilDeUsuario.values()) {
