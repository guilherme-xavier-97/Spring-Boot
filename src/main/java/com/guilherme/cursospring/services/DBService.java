...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7)); // esse Arrays as list
																								// permite que eu salve
																								// varios objetos de uma
																								// vez
...
//---------------------------------------------------------------------------------------------------------------------------------
		...
		Cliente cli2 = new Cliente(null, "José Oliveira", "j@hotmail.com", "04891432705", TipoCliente.PESSOAFISICA,
				bCryptPasswordEncoder.encode("123"));

		cli2.getTelefones().addAll(Arrays.asList("4563456", "867578"));
		cli2.addPerfilDeUsuario(PerfilDeUsuario.ADMIN);
		...
		Endereco e3 = new Endereco(null, "Av Itaquera", "546", null, "Itaquera", "97695", cli2, c2);
